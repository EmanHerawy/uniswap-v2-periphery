...
enum RouterVersion {
  SeaSwapV2Router01 = 'SeaSwapV2Router01',
  SeaSwapV2Router02 = 'SeaSwapV2Router02'
}

describe('SeaSwapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.SeaSwapV2Router01]: fixture.router01,
        [RouterVersion.SeaSwapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SeaSwapV2Router01]: 101876,
              [RouterVersion.SeaSwapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SeaSwapV2Router01]: 138770,
              [RouterVersion.SeaSwapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
